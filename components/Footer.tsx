  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-foreground font-bold text-xl" style={{ fontFamily: "var(--font-playfair)" }}>GO-SSIP</div>
                <div className="label-accent">Café & Restro</div>
              </div>
            </div>
            <p className="text-foreground/60 text-sm leading-relaxed" style={{ fontFamily: "var(--font-dm-sans)" }}>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-foreground/60 text-sm" style={{ fontFamily: "var(--font-dm-sans)" }}>
                  Central Empire, MM Valley C1 Road,<br />Mumbra, Thane, MH 400612
                </span>
              </li>
              <li>
                <a href="tel:+919920564615" className="flex items-center gap-3 text-foreground/60 hover:text-primary transition-colors text-sm" style={{ fontFamily: "var(--font-dm-sans)" }}>
                  <Phone size={16} className="text-primary" />
                  +91 992-056-4615
                </a>
              </li>
              <li>
                <a href="mailto:gossipcafe2024@gmail.com" className="flex items-center gap-3 text-foreground/60 hover:text-primary transition-colors text-sm" style={{ fontFamily: "var(--font-dm-sans)" }}>
        ...
        >
          <p className="text-foreground/40 text-xs" style={{ fontFamily: "var(--font-dm-sans)" }}>
            © {new Date().getFullYear()} GO-SSIP Café & Restro. All rights reserved.
          </p>
          <p className="text-foreground/30 text-xs" style={{ fontFamily: "var(--font-dm-sans)" }}>
